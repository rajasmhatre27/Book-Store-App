...
import googlelogo from '../assets/BannerBooks/googlelogo.png'; // Make sure the path is correct
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        ...
                        <form onSubmit={handleSignup} className="py-8 space-y-4">
                            ...
                            <button type="submit" className="w-full bg-blue-500 text-white rounded py-2 mt-2">Sign Up</button>
                        </form>
                        <hr />
                        <button 
